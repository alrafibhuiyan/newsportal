...
<?php
  ...
  $q = mysqli_query($con,"select * from news where published = '1' ");
...
<div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <p class="bg-secondary"><?php echo htmlentities($row['news_description']);?></p>
                 
              <!-- <a href="news-details.php?nid=<?php //echo htmlentities($row['pid'])?>" class="btn btn-primary">Read More &rarr;</a> -->
            </div>
            <div class="card-footer text-muted">
              Posted on <?php echo htmlentities($row['news_date']);?>
