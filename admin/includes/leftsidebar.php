  ...
  <li class="has_sub">
   ...
   <li class="has_sub">
                  <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span>  Post Permission </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                  <li><a href="unapprove-post.php">Waiting for Post Approval </a></li>
                                    <li><a href="approve-post.php">Approved Post</a></li>
                                </ul>
                            </li>   
