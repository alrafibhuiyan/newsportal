...
<body>
    ...
    echo    "<div class='col-4'><h4><span class='badge badge-dark text-light text-left'>Profile : "  .$res['name']."</span></h4></div>";
    echo    "<div class='col-4'></div>";
    echo    "</div>";
    ...
    echo    "<div class='row row bg-dark text-light p-2'>";
    echo    "<div class='col-2 text-left font-weight-bold'> Gender</div>";
    echo    "<div class='col-10 text-left'>".$res['gender']."</div>";
    echo    "</div>";

    echo    "<div class='row row bg-dark text-light p-2'>";
    echo    "<div class='col-2 text-left font-weight-bold'> Age</div>";
    echo    "<div class='col-10 text-left'>".$res['age']."</div>";
    echo    "</div>";

    echo    "<div class='row row bg-dark text-light p-2'>";
    echo    "<div class='col-2 text-left font-weight-bold'> Religion</div>";
    echo    "<div class='col-10 text-left'>".$res['religion']."</div>";
    echo    "</div>";
